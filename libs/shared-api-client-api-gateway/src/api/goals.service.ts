...
// @ts-ignore
import { CheckInGoalDto } from '../model/check-in-goal-dto';
// @ts-ignore
...
export class GoalsService implements GoalsServiceInterface {
  ...
  public checkIn(
    ...
    if (checkInGoalDto === null || checkInGoalDto === undefined) {
      throw new Error('Required parameter checkInGoalDto was null or undefined when calling checkIn.');
    }
  ...
  public getUsersGoals(
    ...
    if (userId === null || userId === undefined) {
      throw new Error('Required parameter userId was null or undefined when calling getUsersGoals.');
    }
    ...
    let localVarPath = `/api/goals/users/${this.configuration.encodeParam({
      name: 'userId',
      value: userId,
      in: 'path',
      style: 'simple',
