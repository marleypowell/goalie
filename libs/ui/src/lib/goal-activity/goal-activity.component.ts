...
import { GoalActivityMessagePipe } from '../pipes/goal-activity-message.pipe';
import { UserAvatarPipe } from '../pipes/user-avatar.pipe';

@Component({
  selector: 'goalie-goal-activity',
  standalone: true,
  imports: [CommonModule, TimelineModule, AvatarModule, UserAvatarPipe, GoalActivityMessagePipe],
